...
# 1. Configuration - ASK FOR GESTURE NAME
...
options = vision.HandLandmarkerOptions(
    ...
    num_hands=1, # One hand is best for A-Z
...
while cap.isOpened():
    ...
    cv2.imshow("SignSync - Data Collection", frame)
